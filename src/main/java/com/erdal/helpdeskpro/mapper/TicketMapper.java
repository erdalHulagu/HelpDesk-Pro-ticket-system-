...
public class TicketMapper {
	    ...
	    /**
	     * Map UserDTO to Ticket for testing/updating purposes.
	     * NOTE: Only sets the creator from UserDTO id.
	     */
//	    public static Ticket userDTOtoTicket(UserDTO userDTO) {
//	        Ticket ticket = new Ticket();
//	        if (userDTO.getId() != null) {
//	            User user = new User();
//	            user.setId(userDTO.getId());
//	            ticket.setCreatedBy(user); // set creator
//	        }
//	        ticket.setStatus(null); // status can be set later
//	        ticket.setId(null);     // ID will be generated by DB
//	        return ticket;
//	    }

//	    // Existing TicketDTO → Ticket method
...
//
//	        if (ticketDTO.getCreatedById() != null) {
//	            User user = new User();
//	            user.setId(ticketDTO.getCreatedById());
